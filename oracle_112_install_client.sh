...
cd /u01
wget --http-user=$OBINUSER --http-password=$OBINPASS http://dfworacle1.racscan.com/Linux/x86-64/11gR2/11.2.0.4.0/p13390677_112040_Linux-x86-64_4of7_Client.zip
...
echo "export PERL=/u01/app/oracle/product/11.2/client_1/perl/bin/perl" >>/home/oracle/.bash_profile
echo "export PERL5LIB=/u01/app/oracle/product/11.2/client_1/perl/lib" >>/home/oracle/.bash_profile
echo "PATH=/u01/app/oracle/product/11.2/client_1/bin:/u01/app/oracle/product/11.2/client_1/perl/bin:$PATH;export PATH" >>/home/oracle/.bash_profile
