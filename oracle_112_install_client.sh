...
cd /u01
wget --http-user=oracledst --http-password=oracledst http://dfworacle1.racscan.com/Linux/x86-64/11gR2/11.2.0.4.0/p13390677_112040_Linux-x86-64_4of7_Client.zip
